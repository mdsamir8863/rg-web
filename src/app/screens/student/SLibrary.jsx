...
import { fetchLibDetails } from "../../../store/action";
...
const Chapter = () => {
  ...
  useEffect(() => {
    dispatch(fetchLibDetails(id, setChapterDetails));
  }, []);

  return (
    <div className="w-full flex flex-col  items-center">
      <div className="flex px-5 pt-4 w-full font-bold text-3xl">Library</div>
