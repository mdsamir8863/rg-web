...
import { fetchAllLibrary, fetchSearchLibrary } from "../../../store/action";

const Library = ({ setPopUpforElCB }) => {
  ...
  useEffect(() => {
    setPopUpforElCB();
    dispatch(fetchAllLibrary(setAllCourses));
  }, []);

  return (
    <section className="flex flex-col items-center">
      <div className="flex w-full font-bold text-2xl px-5 mt-5">Library</div>
