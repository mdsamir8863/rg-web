...
const ComingSoon = () => {
    return (
        <div className="relative z-[-1] h-screen w-full flex items-center justify-center bg-cover bg-center text-center px-5"
            ...
            <div className="z-50 flex flex-col justify-center text-white w-full h-screen">
                <span className="text-bold">Rankers Guide</span>
                <h1 className="text-5xl">Coming <b>Soon</b> !</h1>
                ...
                <div className="mt-6 flex text-white mx-auto">
                    <a href="/#">
                        <svg fill="currentColor" className="cursor-pointer h-10 mr-2" viewBox="0 0 24 24" version="1.1"
                    ...
                    <a href="/#">
                        <svg fill="currentColor" className="cursor-pointer h-10 mr-2" viewBox="0 0 24 24" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve">
                            <path id="Combined-Shape" d="M12,24c6.627,0 12,-5.373 12,-12c0,-6.627 -5.373,-12 -12,-12c-6.627,0 -12,5.373 -12,12c0,6.627 5.373,12 12,12Zm6.591,-15.556l-0.722,0c-0.189,0 -0.681,0.208 -0.681,0.385l0,6.422c0,0.178 0.492,0.323 0.681,0.323l0.722,0l0,1.426l-4.675,0l0.002,-0.808c0,-0.422 0.04,-0.648 0.646,-0.648l0.809,0l0,-1.616l-1.295,0c-1.555,0 -2.103,0.784 -2.103,2.102l0,0.97l-0.969,0l0,1.617l0.969,0l0,4.689l1.941,0l0,-4.689Z"></path>
                        </svg>
                    </a>
                </div>
            </div>
