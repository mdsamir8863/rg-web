<div className="relative w-full p-2  h-full md:h-screen mx-auto shadow-2xl md:pt-24  text-center overflow-hidden bg-gradient-to-r from-blue-400 via-purple-200 to-blue-300 bg-black">
  <img
    className="absolute hidden md:block z-50 top-0 left-1 w-28  rounded-lg"
    src={RgLogo}
    alt="Ranker Guid Logo"
  />
